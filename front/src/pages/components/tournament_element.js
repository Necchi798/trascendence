		...
		this.innerHTML = /*html*/`
			<div style="display: flex; flex-direction: column; justify-content: center; align-items: center;">
				<div style="display: flex; flex-direction: column; justify-content: center; align-items: center;">
					...
					<div style="display: flex; flex-direction: row; justify-content: center; align-items: center;">
						<button id="playButton" style="font-family: 'Silkscreen', sans-serif; font-size: 20px; margin-top: 30px; margin-left: 5px; padding: 10px 20px; background-color: #C1EBC5; border: none; border-radius: 5px; cursor: pointer;">Start Match: Player 1 vs Player 2</button>
					</div>
				</div>
			</div>
		`;
